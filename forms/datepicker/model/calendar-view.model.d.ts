...
export declare class CalendarViewModel {
     ...
     */
    private generateDayViewModels(days, isDisabled, isCurrentCalendar);
    /**
     ...
     */
    private numDaysFromPrevMonthInCalView(currentYear, currentMonth);
    /**
     * Checks if the Day passed is in the CalendarView.
     */
    private isDayInCalendarView(day);
    /**
     * Using the DayViewModels from the previous, current and next month, this function
     * generates the CalendarView.
     */
    private generateCalendarView(prev, curr, next);
    /**
    ...
    private setFocusableFlag(day, flag);
    /**
